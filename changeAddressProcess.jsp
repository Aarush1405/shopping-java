 <jsp:useBean id="mybean1" class="shopping.User" />
<jsp:setProperty name="mybean1" property="*" />
<%@ page language="java" session="true" %>
<%@ page import="java.sql.*" %>
<%
	int id=Integer.parseInt(request.getParameter("userid"));
	int a = mybean1.changeAddress();
 ...
 <script src=" https://kit.fontawesome.com/71a06f9aff.js" crossorigin="anonymous">
                ...
                <div class="container">
                    ...
                    <div class="p">
                        ...
                        <a href="cart.jsp?userid=<%=id%>"><button type="submit">Okay</button></a>
                    </div>
                </div>
